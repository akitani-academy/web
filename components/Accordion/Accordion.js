...
export const accordionData02 = [
  {
    title: "講師の資格と経験は？",
    content: `当アカデミィの講師はグループ指導・個別指導ともに、英検1級・TOEIC950以上の合格実績豊富なベテラン講師が指導いたします。東大卒や東京外語大卒等の各々得意な指導分野と指導実績豊富なバイリンガル講師に、Native講師が英会話・speaking・英文添削・英文監修を担当して合格に導きます。大学生などの学生講師はおりません。`,
  },
  {
    title: "カリキュラムの内容は？",
