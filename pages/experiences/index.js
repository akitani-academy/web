...
export default function Page({ data }) {
  return (
    <>
      <Head
        url={`/experiences`}
        title="英検1級183人/東大早慶上智9割以上の合格実績と体験記"
        breadcrumb={[
          ["トップページ", ""],
          ["実績", "/experiences"],
        ]}
        description="秋谷光子アカデミィは英語専門塾として開塾36年、英検1級合格累計183人、東大を始め早慶・上智大など第一志望校に9割以上合格しました。圧倒的な実績に合わせて合格体験記を数多く掲載しております。"
      />
      <h1>合格実績 と 体験記</h1>
      <p>
        秋谷光子アカデミィは英語専門塾として開塾36年、英検1級合格累計183人、東大を始め早慶・上智大など第一志望校に9割以上合格しました。圧倒的な実績に合わせて合格体験記を数多く掲載しております。
      </p>
      ...
      {data.map((e, i) => (
        <>
          ...
          {e.child_list.map(
            (e1, i) =>
              0 < e1.post.length && <ExperiencesList data={e1} key={i} />
          )}
        </>
      ))}
      <ContactButton />
