            ...
            <main className={`${css_index.main} lp_main`}>
                <div className={css_index.fv}>
                    <div className={css_index.fv__inner}>
                        ...
                        <h2>
                            志望校合格
                            <span className={css_index.small}>に</span>導く
                            <br />
                            大学受験英語塾
                        </h2>
                        <p>
                    ...
                    >
                        ...
                        <div className={css_index.box}>
                            ...
                            >
                                <h4>国立大学</h4>
                                <div
                                    className={`${css_index.cont} ${css_index.cont_01}`}
                                >
                                    <div
                            ...
                            >
                                <h4>私立大学</h4>
                                <div
                                    className={`${css_index.cont} ${css_index.cont_02}`}
                                >
                                    <div
                                        className={`${css_index.cont__item} ${css_index.cont__item_01}`}
                                    >
                        ...
                        <div className={`${css_index.box}`}>
                            ...
                            <picture>
                                ...
                                <img
                                    ...
                                    alt="英検1級合格 累計188名 東大・早慶・上智大など第一志望校に9割以上合格"
                                />
                            </picture>
                        </div>
                    </div>
                                ...
                                <div className={css_index.card_box}>
                                    ...
                                    <div className={css_index.card_box__inner}>
                                        ...
                                        <div className={css_index.bottom}>
                                            ...
                                            <div className={css_index.center}>
                                                <Link href="./method/medical-school">
                                                    詳細をみる
                                                </Link>
                                            </div>
                                        </div>
                                ...
                                <div className={css_index.card_box}>
                                    ...
                                    <div className={css_index.card_box__inner}>
                                        ...
                                        <div className={css_index.bottom}>
                                            ...
                                            <div className={css_index.center}>
                                                <Link href="./method/prestigious-uni">
                                                    詳細をみる
                                                </Link>
                                            </div>
                                        </div>
                ...
                <section
                    className={`${css_index.section} ${css_index.section_15}`}
                >
                    <h2 className={css_index.title_blue}>
                        <span>学習空間のこだわり</span>
                    </h2>
                ...
                <section
                    className={`${css_index.section} ${css_index.section_16}`}
                >
                    <h2 className={css_index.title_blue}>
                        <span>よくある質問</span>
                    </h2>
                ...
                <section
                    className={`${css_index.section} ${css_index.section_17}`}
                >
                    <h2 className={css_index.title_blue}>
                        <span>各校の問い合わせ先</span>
                    </h2>
